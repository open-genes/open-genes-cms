...
class PhysicalActivity extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['p_value', 'result', 'duration', 'measurement_taken', 'training_regimen', 'participants', 'age', 'age_units', 'experiment_groups_quantity', 'reference', 'expression_change_log'], 'string', 'max' => 255],
