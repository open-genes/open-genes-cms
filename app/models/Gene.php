...
class Gene extends common\Gene
{
    ...
    public function attributeLabels()
    {
        return [
            'id' => 'id',
            'family_phylum_id' => Yii::t('common', 'Family phylum id'),
            'phylum_id' => Yii::t('common', 'Phylum id'),
            'symbol' => Yii::t('common', 'HGNC'),
            ...
            'commentEvolution' => Yii::t('common', 'Evolution'),
            'uniprot_summary_ru' => Yii::t('common', 'Uniprot summary Ru'),
            'commentCause' => Yii::t('common', 'Comment cause'),
            'commentAging' => Yii::t('common', 'Relation to aging'),
            'commentEvolutionEN' => Yii::t('common', 'Evolution En'),
            'uniprot_summary_en' => Yii::t('common', 'Uniprot summary En'),
            'commentAgingEN' => Yii::t('common', 'Relation to aging En'),
            'commentsReferenceLinks' => Yii::t('common', 'Reference links'),
            'functionalClusters' => Yii::t('common', 'Functional cluster'),
            'functionalClustersIdsArray' => Yii::t('common', 'Functional cluster'),
            'diseasesIdsArray' => Yii::t('common', 'Disease'),
            'commentCauseIdsArray' => Yii::t('common', 'Comment cause'),
            'isHidden' => Yii::t('common', 'Hidden'),
            'proteinClassesIdsArray' => Yii::t('common', 'Protein class'),
            'expressionChange' => Yii::t('common', 'Expression change'),
            'protein_complex_ru' => Yii::t('common', 'Protein complex Ru'),
            'protein_complex_en' => Yii::t('common', 'Protein complex En'),
            'source' => Yii::t('common', 'Source'),
            'ncbi_summary_ru' => Yii::t('common', 'NCBI summary Ru'),
            'ncbi_summary_en' => Yii::t('common', 'NCBI summary En'),
            'og_summary_en' => Yii::t('common', 'Open Genes summary En'),
            'og_summary_ru' => Yii::t('common', 'Open Genes summary Ru'),
        ];
    }
