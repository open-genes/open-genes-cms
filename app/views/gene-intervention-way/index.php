...
$this->title = Yii::t('app', 'Gene Intervention Ways');
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="gene-intervention-way-index">
    ...
    <?= GridView::widget([
        ...
        'columns' => [
            ...
            [
                'label' => '🔗 genes',
                'value' => function($model, $index, $dataColumn) { /** @var $model \app\models\GeneInterventionWay */
