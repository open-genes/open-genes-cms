...
$this->title = 'Оценка экспрессии по ';
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="expression-evaluation-index">

    <h1><?= Html::encode($this->title) ?></h1>

    <p>
        <?= Html::a('Добавить оценку экспресии по ', ['create'], ['class' => 'btn btn-success']) ?>
    </p>
    ...
    <?= GridView::widget([
        ...
        'columns' => [
            ...
            [
                'label' => '🔗 genes',
                'value' => function($model, $index, $dataColumn) { /** @var $model \app\models\ExpressionEvaluation */
