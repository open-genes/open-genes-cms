...
$this->title = Yii::t('app', 'Active Substance Delivery Ways');
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="active-substance-delivery-way-index">
    ...
    <?= GridView::widget([
        ...
        'columns' => [
            ...
            [
                'label' => '🔗 genes',
                'value' => function($model, $index, $dataColumn) { /** @var $model \app\models\ActiveSubstanceDeliveryWay */
