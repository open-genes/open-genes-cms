...
$this->title = Yii::t('app', 'Statistical Significances');
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="statistical-significance-index">
    ...
    <?= GridView::widget([
        ...
        'columns' => [
            ...
            [
                'label' => '🔗 genes',
                'value' => function($model, $index, $dataColumn) { /** @var $model \app\models\StatisticalSignificance */
